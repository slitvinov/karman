...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(((L->m)->b[i][j]))) qassert ("/home/lisergey/basilisk/src/grid/tree.h", 1005, "mem_data (L->m,i,j)");
  ...
  if (--L->nc == 0) {
    destroy_layer (L);
    if (!(point.level + 1 == grid->depth)) qassert ("/home/lisergey/basilisk/src/grid/tree.h", 1012, "point.level + 1 == grid->depth");
    update_depth (-1);
  }
}
...
void check_two_one (void)
{
 ...
 for (int l = -1; l <= 1; l++) {
   ...
   if (x > -0.5 && x < 0.5 && y > -0.5 && y < 0.5 &&
     ...
     if (!(false)) qassert ("/home/lisergey/basilisk/src/grid/tree.h", 1623, "false");
   }
 }end_foreach_leaf();}
}
 ...
 inside = false;
    if (inside) {
      ...
      fprintf (fp, "%g %g\n%g %g\n%g %g\n%g %g\n%g %g\n\n",
        ...
        x + Delta, y - Delta,
        x - Delta, y - Delta);
#line 629 "/home/lisergey/basilisk/src/grid/cartesian-common.h"
    }
  }end_foreach();}
  fflush (fp);
}
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  fputc ('\n', fp);
#line 708 "/home/lisergey/basilisk/src/grid/cartesian-common.h"
    for (int k = -2; k <= 2; k++)
      for (int l = -2; l <= 2; l++) {
 {scalar*_i=(scalar*)( all);if(_i)for(scalar v=*_i;(&v)->i>=0;v=*++_i){ {
   fprintf (fp, "%g %g ",
...
#line 738 "/home/lisergey/basilisk/src/grid/cartesian-common.h"
  fclose (fp);
...
#line 807 "/home/lisergey/basilisk/src/grid/cartesian-common.h"
}
...
void periodic (int dir)
{
    ...
    if (!(dir <= bottom)) qassert ("/home/lisergey/basilisk/src/grid/cartesian-common.h", 904, "dir <= bottom");
...
{scalar*_i=(scalar*)( vl.y);if(_i)for(scalar s=*_i;(&s)->i>=0;s=*++_i){
  ...
  for (int l = depth() - 1; l >= 0; l--)
    {foreach_halo (prolongation, l)
      {
        if (vl.x) {
#line 403 "/home/lisergey/basilisk/src/grid/tree-common.h"
...
#line 464 "/home/lisergey/basilisk/src/grid/tree-common.h"
      }
...
#line 522 "/home/lisergey/basilisk/src/grid/tree-common.h"
}
...
#line 582 "/home/lisergey/basilisk/src/grid/tree-common.h"
  }
...
#line 684 "/home/lisergey/basilisk/src/grid/tree-common.h"
...
#line 292 "/home/lisergey/basilisk/src/geometry.h"
...
#line 19 "/home/lisergey/basilisk/src/fractions.h"
...
#line 138 "/home/lisergey/basilisk/src/fractions.h"
  vector p;
  p.x = as.y; p.y = as.x;
...
#line 198 "/home/lisergey/basilisk/src/fractions.h"
  scalar s_z = c;
  foreach_stencil()
...
#line 341 "/home/lisergey/basilisk/src/fractions.h"
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  coord n;
  double nn = 0.;
  if (!(2 == 2)) qassert ("/home/lisergey/basilisk/src/fractions.h", 389, "dimension == 2");
   {
...
#line 523 "/home/lisergey/basilisk/src/fractions.h"
    }        }end_foreach_stencil();
  {
#line 502
foreach()
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
 ...
 if (!(coarse(cs,child.x,0,0) && coarse(cs,0,child.y,0))) qassert ("/home/lisergey/basilisk/src/embed-tree.h", 280, "coarse(cs,child.x) && coarse(cs,0,child.y)");
 if (coarse(fs.x,i,child.y,0) && coarse(fs.y,child.x,j,0)) {

   if (!(coarse(cs,child.x,child.y,0))) qassert ("/home/lisergey/basilisk/src/embed-tree.h", 283, "coarse(cs,child.x,child.y)");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(val(cs,i,0,0) && val(cs,i-1,0,0))) qassert ("/home/lisergey/basilisk/src/embed.h", 74, "cs[i] && cs[i-1]");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(val(cs,0,i,0) && val(cs,0,i-1,0))) qassert ("/home/lisergey/basilisk/src/embed.h", 74, "cs[i] && cs[i-1]");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  if (!(2 == 2)) qassert ("/home/lisergey/basilisk/src/embed.h", 257, "dimension == 2");
...
#line 418 "/home/lisergey/basilisk/src/embed.h"
      else
 break;
    }
  if (v[0] == 1e30) {
...
#line 458 "/home/lisergey/basilisk/src/embed.h"
  return 1e30;
}
...
#line 536
{
 ...
 mua /= fa;
#line 599 "/home/lisergey/basilisk/src/embed.h"
 if (!(2 == 2)) qassert ("/home/lisergey/basilisk/src/embed.h", 599, "dimension == 2");
...
#line 616 "/home/lisergey/basilisk/src/embed.h"
...
#line 633 "/home/lisergey/basilisk/src/embed.h"
...
{tracing("output_gfs","/home/lisergey/basilisk/src/output.h",787);
 ...
 3;
#line 899 "/home/lisergey/basilisk/src/output.h"
      if (is_leaf(cell))
 flags |= (1 << 4);
...
, TOLERANCE_MU ? TOLERANCE_MU : TOLERANCE);delete((scalar*)((vector[]){r,{{-1},{-1}}}));{end_tracing("viscosity","/home/lisergey/basilisk/src/viscosity-embed.h",166);return _ret;}}delete((scalar*)((vector[]){r,{{-1},{-1}}}));
...
int output_xdmf(double t, scalar *list, vector *vlist, const char *path) {
  ...
  {foreach_cell() if (is_local(cell) && is_leaf(cell)) {
    ...
    if (ncell >= nsize) {
      nsize = 2 * nsize + 1;
      if ((xyz = prealloc(xyz, 4 * 3 * nsize * sizeof *xyz,__func__,__FILE__,__LINE__)) == NULL) {
...
char *end;
  ...
  L0 = 4;
  origin(-0.5, -L0 / 2.
#line 928 "/home/lisergey/basilisk/src/common.h"
, 0.
#line 141 "cylinder.c"
);
...
#line 164
      static int dump_0(const int i,const double t,Event *_ev){tracing("dump_0","cylinder.c",164); {
  ...
  if (i % period == 0) {
    ...
    if (output_prefix != NULL) {
      ...
      output_xdmf(t,((scalar[]) {p, omega,{-1}}),((vector[]) {u,{{-1},{-1}}}), path);
      if (Image) {
        foreach_stencil ()
...
foreach ()
        ...
        output_ppm(omega
#line 551 "/home/lisergey/basilisk/src/output.h"
, 
fout
#line 185 "cylinder.c"
, 512, path
, -2 / diameter
, 2 / diameter
#line 555 "/home/lisergey/basilisk/src/output.h"
, 5, 
0
#line 187 "cylinder.c"
, false
#line 186
,
#line 558 "/home/lisergey/basilisk/src/output.h"
(
...
{{-0.5, -0.5}, {L0 - 0.5, 0.5}}
, m
#line 559 "/home/lisergey/basilisk/src/output.h"
, 
jet, 
NULL
#line 187 "cylinder.c"
...
}{end_tracing("dump_0","cylinder.c",191);return 0;}end_tracing("dump_0","cylinder.c",191);}
static int adapt_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}

#line 192
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","cylinder.c",192); {
  adapt_wavelet(
#line 193 "/home/lisergey/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 193
...
}{end_tracing("adapt_0","cylinder.c",195);return 0;}end_tracing("adapt_0","cylinder.c",195);}
...
#line 148 "cylinder.c"
event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"cylinder.c",148,"init"});  
#line 164
...
#line 146 "cylinder.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"cylinder.c",146,"properties"});  
#line 192
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"cylinder.c",192,"adapt"});
