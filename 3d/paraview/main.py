...
renderView1.CenterOfRotation = [504.8041639328003, 31.59588623046875, 506.63003063201904]
renderView1.KeyLightWarmth = 0.5
renderView1.FillLightWarmth = 0.5
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [-2074.958443060363, 2167.0582426527603, 1707.2474342700255]
renderView1.CameraFocalPoint = [765.5794662595805, 508.8841664915863, 465.80266374908916]
renderView1.CameraViewUp = [0.3472719068449284, 0.8653781398795282, -0.3612795285301056]
...
meshxdmf2 = XDMFReader(registrationName='mesh.xdmf2', FileNames=['/home/lisergey/cudaAmrIsoSurfaceExtraction/mesh.xdmf2'])
meshxdmf2.PointArrayStatus = ['Attribute_3']
meshxdmf2.GridStatus = ['Grid_2']

# create a new 'Extract Surface'
extractSurface1 = ExtractSurface(registrationName='ExtractSurface1', Input=meshxdmf2)
...
attribute_3LUT.RGBPoints = [-1.0, 0.176471, 0.0, 0.294118, -0.87451, 0.272434, 0.095963, 0.444214, -0.74902, 0.373395, 0.228912, 0.56932, -0.623529, 0.481661, 0.415917, 0.657901, -0.498039, 0.601922, 0.562937, 0.750481, -0.372549, 0.718493, 0.695886, 0.836986, -0.24705900000000003, 0.811995, 0.811534, 0.898501, -0.12156900000000004, 0.894733, 0.8995, 0.940023, 0.00392156999999993, 0.969166, 0.966859, 0.963629, 0.12941200000000008, 0.98639, 0.910265, 0.803691, 0.25490199999999996, 0.995002, 0.835371, 0.624375, 0.38039200000000006, 0.992541, 0.736947, 0.420146, 0.5058820000000004, 0.931949, 0.609458, 0.224221, 0.631373, 0.85075, 0.483968, 0.069819, 0.7568630000000001, 0.740023, 0.380623, 0.035371, 0.8823530000000002, 0.617993, 0.29827, 0.026759, 1.0, 0.498039, 0.231373, 0.031373]
...
generateSurfaceNormals1Display.ScaleTransferFunction.Points = [-117.15668487548828, 0.0, 0.5, 0.0, 117.43035888671875, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
generateSurfaceNormals1Display.OpacityTransferFunction.Points = [-117.15668487548828, 0.0, 0.5, 0.0, 117.43035888671875, 1.0, 0.5, 0.0]
